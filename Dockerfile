...
RUN apt update && apt install -y --fix-missing python3-pip python3-opencv nano
...
RUN apt-get update && apt install -y libboost-python-dev libboost-thread-dev libcanberra-gtk-module libcanberra-gtk3-module
